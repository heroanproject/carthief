...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChainForRestApi(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .requestMatchers(HttpMethod.GET, "/api/dealers/**").hasAuthority(Role.USER.getAuthority())
                .requestMatchers(HttpMethod.GET, "/api/cars/**").hasAuthority(Role.USER.getAuthority())
                .requestMatchers(HttpMethod.GET, "/api/persons/**").hasAuthority(Role.USER.getAuthority())
